...
<div class="container-fluid py-4">
    <div class="row mb-4">
        <div class="col-md-8">
            <h2>Nuevo Inquilino - {{ $propiedad->nombre }}</h2>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('propiedades.inquilinos.store', $propiedad->id) }}">
                        @csrf
                        ...
                        <div class="d-flex gap-2">
                            <button type="submit" class="btn btn-primary">
                                <i class="bi bi-check-circle"></i> Guardar Inquilino
                            </button>
